...
| --- | --- | --- |
|  [!DNL Microsoft 365 Copilot][&#128279;](ama-ms.md)용 Adobe Marketing Agent | [!DNL Teams], [!DNL Word], [!DNL Powerpoint] 및 [!DNL Excel]과(와) 같은 [!DNL Microsoft 365] 앱에서 Adobe Experience Platform에서 마케팅 인사이트를 즉시 검색합니다. 이 에이전트를 사용하면 앱 간 채팅 기록을 유지하고 작업할 때 대화를 원활하게 계속할 수 있습니다. |
