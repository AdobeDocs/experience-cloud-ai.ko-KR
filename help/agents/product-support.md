...
>[!AVAILABILITY]
>
>제품 지원 에이전트는 제한된 기간 동안 자격이 있는 고객이 사용할 수 있습니다. 제품 지원 에이전트에 대한 액세스는 2026년 2월 28일에 종료됩니다. 이 날짜 이후에도 중단 없이 제품 지원 에이전트를 계속 사용하려면 Adobe 계정 담당자에게 문의하여 Adobe Experience Platform Agent Orchestrator 라이선스에 대해 자세히 알아보십시오.
...
권한을 활성화하고 AI Assistant에 액세스하는 방법은 [액세스 가이드](./agent-orchestrator.md#access)를 따르십시오.
