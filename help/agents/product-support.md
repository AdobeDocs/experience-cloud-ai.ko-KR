...
>[!AVAILABILITY]
>
>**제한된 시간 액세스**: 제품 지원 에이전트를 사용해 보시기 바랍니다. 이 기능에 대한 액세스는 2026년 2월 28일에 종료됩니다. 제품 지원 에이전트를 중단 없이 계속 사용하려면 Adobe 계정 담당자에게 문의하여 제품 지원 에이전트 라이선싱에 대한 자세한 내용을 확인하십시오.
