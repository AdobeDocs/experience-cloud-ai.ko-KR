---
title: CX 엔터프라이즈 MCP 툴 액세스
description: Adobe CX Enterprise MCP 도구를 사용하기 전에 제품 가용성, 조직 활성화 및 권한을 확인하십시오.
...
# CX 엔터프라이즈 MCP 툴 액세스 {#mcp-access}
...
Beta 또는 제한된 릴리스 제품 도구의 경우 Adobe 계정 담당자에게 연락하여 사용할 CX용 Adobe Enterprise MCP 제품 도구를 지정하십시오. 담당자가 제품 활성화를 조정하고 Adobe 조직이 준비되었는지 확인할 수 있습니다.
...
다음: [CX Enterprise MCP용 Adobe 설치](install.md)